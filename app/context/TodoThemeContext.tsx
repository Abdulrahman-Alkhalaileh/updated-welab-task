...
const TodoThemeContext =
    createContext<TodoThemeContextValue>(initialContextValue);

// Create the ThemeProvider component
export const TodoThemeProvider: React.FC<{ children: ReactNode }> = ({
    children,
}) => {
